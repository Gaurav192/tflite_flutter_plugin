...
1. Run **`flutter pub run tflite_flutter:install`**
...
2. Use **`flutter pub run tflite_flutter:install -d`** instead if you wish to use these `GpuDelegateV2` and `NnApiDelegate`.
...
1. Run **`flutter pub run tflite_flutter:install`**.
2. For building a custom version of tensorflow, follow [instructions in wiki](https://github.com/am15h/tflite_flutter_plugin/wiki/).
